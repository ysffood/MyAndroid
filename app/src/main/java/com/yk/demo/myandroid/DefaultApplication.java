...
import com.yk.demo.myandroid.logger.AndroidLogAdapter;
import com.yk.demo.myandroid.logger.LogLevel;
...
public class DefaultApplication extends Application {
    ...
    private final static String DB_KEY = "db_key"; // 数据库加密密码
...
//                .hideThreadInfo()               // default shown
                .logLevel(LogLevel.FULL)        // default LogLevel.FULL 开关
